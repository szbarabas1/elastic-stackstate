...
command="curl -vv -H 'Content-Type: application/json' -XPUT 'stackstate.apps.ocp.qa.ondit.net:9200/sts_multi_metrics-"+indexdate+"/_settings' -d ' { "+'"'+"index.mapping.total_fields.limit"+'"'+": 5000 }'"
print (command)
